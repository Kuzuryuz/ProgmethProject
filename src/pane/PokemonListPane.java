...
public class PokemonListPane {
    ...
    private PokemonListPane() {
        ...
        pokemons.add(new Pokemon("Baxcalibur", Type.DRAGON, Type.ICE, 575, 145, 92, 75, 86, 87, "pokemon/baxcalibur.png",
        ...
        pokemons.add(new Pokemon("Blaziken", Type.FIRE, Type.FIGHTING, 400, 160, 80, 130, 80, 100, "pokemon/blaziken.png",
        ...
        pokemons.add(new Pokemon("Delphox", Type.FIRE, Type.PSYCHIC, 375, 69, 72, 114, 100, 104, "pokemon/delphox.png",
        ...
        pokemons.add(new Pokemon("Dragonite", Type.DRAGON, Type.FLYING, 455, 134, 95, 100, 100, 80, "pokemon/dragonite.png",
        ...
        pokemons.add(new Pokemon("Gardevoir", Type.FAIRY, Type.PSYCHIC, 340, 65, 65, 125, 115, 80, "pokemon/gardevoir.png",
                new BaseSkill[]{new BaseSkill("Thunderbolt", Type.ELECTRIC, Category.SPECIAL, Status.PARALYSIS, new Buff[]{Buff.NONE}, 15,90,0,10,100,false),
                        ...
                        new BaseSkill("Shadow Ball", Type.GHOST, Category.SPECIAL, Status.NONE, new Buff[]{Buff.SPDEFDOWN}, 15,80,20,0,100,false)}));
        pokemons.add(new Pokemon("Greninja", Type.WATER, Type.DARK, 360, 95, 67, 103, 71, 122, "pokemon/greninja.png",
        ...
        pokemons.add(new Pokemon("Iron Thorns", Type.ROCK, Type.ELECTRIC, 500, 134, 110, 70, 84, 72, "pokemon/ironthorns.png",
                new BaseSkill[]{new BaseSkill("Wild Charge", Type.ELECTRIC, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.RECOIL}, 15,90,100,0,100,false),
                        ...
                        new BaseSkill("Earthquake", Type.GROUND, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.NONE}, 10,100,0,0,100,false),
                        new BaseSkill("Stone Edge", Type.ROCK, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.NONE}, 5,100,0,0,80,false)}));
        pokemons.add(new Pokemon("Leafeon", Type.GRASS, Type.NULL, 325, 110, 130, 60, 65, 95, "pokemon/leafeon.png",
        ...
        pokemons.add(new Pokemon("Lucario", Type.FIGHTING, Type.STEEL, 350, 110, 70, 115, 70, 90, "pokemon/lucario.png",
        ...
        pokemons.add(new Pokemon("Magcargo", Type.FIRE, Type.ROCK, 300, 50, 120, 90, 80, 30, "pokemon/magcargo.png",
                new BaseSkill[]{new BaseSkill("Blaze Kick", Type.FIRE, Category.PHYSICAL, Status.BURN, new Buff[]{Buff.NONE}, 10,85,0,10,90,false),
                        new BaseSkill("Close Combat", Type.FIGHTING, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.DEFDOWN2, Buff.SPDEFDOWN2}, 5,120,100,0,100,true),
                        new BaseSkill("Swords Dance", Type.NORMAL, Category.BUFF, Status.NONE, new Buff[]{Buff.ATKUP2}, 20,0,100,0,100,true),
                        new BaseSkill("Stone Edge", Type.ROCK, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.NONE}, 5,100,0,0,80,false)}));
        pokemons.add(new Pokemon("Mimikyu", Type.GHOST, Type.FAIRY, 275, 90, 80, 50, 105, 96, "pokemon/mimikyu.png",
                new BaseSkill[]{new BaseSkill("Will-o-Wisp", Type.FIRE, Category.STATUS, Status.BURN, new Buff[]{Buff.NONE}, 15,0,100,0,85,false),
                        ...
                        new BaseSkill("Shadow Claw", Type.GHOST, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.NONE}, 15,70,0,0,100,false)}));
        pokemons.add(new Pokemon("Rayquaza", Type.DRAGON, Type.FLYING, 525, 180, 100, 180, 100, 115, "pokemon/rayquaza.png",
                new BaseSkill[]{new BaseSkill("Thunder", Type.ELECTRIC, Category.SPECIAL, Status.PARALYSIS, new Buff[]{Buff.NONE}, 10,110,0,10,70,false),
                        ...
                        new BaseSkill("Hurricane", Type.FLYING, Category.SPECIAL, Status.NONE, new Buff[]{Buff.NONE}, 10,110,0,0,70,false)}));
        pokemons.add(new Pokemon("Sceptile", Type.GRASS, Type.NULL, 350, 85, 65, 105, 85, 120, "pokemon/sceptile.png",
        ...
        pokemons.add(new Pokemon("Scolipede", Type.BUG, Type.POISON, 300, 100, 89, 55, 69, 112, "pokemon/scolipede.png",
        ...
        pokemons.add(new Pokemon("Snorlax", Type.NORMAL, Type.NULL, 800, 110, 65, 65, 110, 30, "pokemon/snorlax.png",
        ...
        pokemons.add(new Pokemon("Swampert", Type.WATER, Type.GROUND, 500, 150, 110, 95, 110, 70, "pokemon/swampert.png",
        ...
        pokemons.add(new Pokemon("Togekiss", Type.FAIRY, Type.FLYING, 425, 50, 95, 120, 115, 80, "pokemon/togekiss.png",
        ...
        pokemons.add(new Pokemon("Weavile",Type.DARK,Type.ICE,350,120,65,45,85,125, "pokemon/weavile.png",
                new BaseSkill[]{new BaseSkill("Night Slash", Type.DARK, Category.PHYSICAL, Status.NONE, new Buff[]{Buff.NONE}, 15,70,0,10,100,false),
                        new BaseSkill("Swords Dance", Type.NORMAL, Category.BUFF, Status.NONE, new Buff[]{Buff.ATKUP2}, 20,0,100,0,100,true),
        ...
        pokemons.add(new Pokemon("Wo-Chien", Type.DARK, Type.GRASS, 425, 85, 100, 95, 135, 70, "pokemon/wo-chien.png",
                new BaseSkill[]{new BaseSkill("Leaf Storm", Type.GRASS, Category.SPECIAL, Status.NONE, new Buff[]{Buff.SPADOWN2}, 5,130,100,0,90,true),
                        new BaseSkill("Body Slam", Type.NORMAL, Category.PHYSICAL, Status.PARALYSIS, new Buff[]{Buff.NONE}, 15,85,0,30,100,false),
        ...
        pokemons.add(new Pokemon("Umbreon", Type.DARK, Type.NULL, 475, 65, 110, 60, 130, 65, "pokemon/umbreon.png",
